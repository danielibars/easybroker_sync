...
function property_cpt() {
	...
	$labels = array(
		...
		'featured_image'        => __( 'Featured Image', 'ibars_easybroker_sync' ),
		'set_featured_image'    => __( 'Set featured image', 'ibars_easybroker_sync' ),
		'remove_featured_image' => __( 'Remove featured image', 'ibars_easybroker_sync' ),
		'use_featured_image'    => __( 'Use as featured image', 'ibars_easybroker_sync' ),
